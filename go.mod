...
// Pin testcontainers-go to v0.41.0 (last release on github.com/docker/docker
// types); v0.42.0 via qor5/go-bus migrated to moby/moby/api, incompatible with
// our testenv. Matches qor5/x gormx.
